...
export class AppComponent {
  title = 'employee-portal-demo-application';
  ...
  empSalary = 15000
  location = "Kochi"
  updateEmployeeDetails(name:string, designation:string, id:string){
    alert("Employee Name: "+name+", Designation: "+designation+", ID: "+id);
  }
